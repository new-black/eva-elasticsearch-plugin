...
//
//    override fun reduce(aggregations: MutableList<InternalAggregation>?, reduceContext: ReduceContext?): InternalAggregation {
//        var reduced: InternalAggregation? = null
//
//        if(aggregations != null) {
//            val aggregationsList = ArrayList<InternalAggregations>(aggregations.size)
//
...
//    }
//
//    override fun reduceBucket(buckets: MutableList<InternalBucket>?, context: ReduceContext?): InternalBucket {
...
//        return ProductVariationStockAggregation(this.name, buckets, this.metadata)
//    }
//
...
//
//        return ProductVariationStockAggregation(getName(), ordered, getMetadata())
//    }
//
//    @Throws(IOException::class)
...
//        val that = other as ProductVariationStockAggregation
